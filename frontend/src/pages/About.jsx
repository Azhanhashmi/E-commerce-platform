...
import azhan1 from '../assets/azhan1.jpg'
  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        <img className='w-full md:max-w-[450px]' src={azhan1} alt=""/>
        <div className='flex flex-col justify-center gap-6 md:w-2/4'>
            <p>Most people follow a tutorial to build a site; I built a platform to solve the "where did I put that receipt?" problem—then I turned it into this. Founded by Azhan, this project began at the intersection of a  logic and a designer’s eye for aesthetics.</p>
